module.exports = function(thisRecord){
    ...
    var targetEmail;
    console.log(findSSN);
    Patients.findOne({ SSN: findSSN },function(err,patientRecord){
        ...
        let mailOptions = {
            ...
            subject: 'Your medical bill...', // Subject line
            text: 'Your medical bill for today\'s appointment', // plain text body
            html: '<p>You were marked as \"No Show\" for today\'s appointment.  <a href="http://localhost:3003/payMyBill/' + thisRecord._id + '">View and pay your bill at this link.</a></p>'// html body
        };
